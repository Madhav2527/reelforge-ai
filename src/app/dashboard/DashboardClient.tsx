...
export default function DashboardClient({ currencySymbol, price, pricePerGen, country }: { currencySymbol: string, price: string, pricePerGen: string, country: string }) {
        ...
        <div className="glass-card p-6 rounded-2xl border border-purple-500/20 bg-gradient-to-br from-purple-500/5 to-pink-500/5 flex flex-col justify-between">
          <div>
            ...
            <div className="text-3xl font-bold text-white mb-1">
              {currencySymbol}{price}<span className="text-sm font-normal text-muted-foreground">/mo</span>
            </div>
            <p className="text-xs text-muted-foreground mb-4">Or {currencySymbol}{pricePerGen} per single generation</p>
          </div>
